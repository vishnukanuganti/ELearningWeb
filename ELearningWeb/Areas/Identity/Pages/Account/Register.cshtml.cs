...
namespace ELearningWeb.Areas.Identity.Pages.Account
{
    ...
    if (ModelState.IsValid)
    {
        ...
        var result = await _userManager.CreateAsync(user, Input.Password);
            ...
            else
            {
                ...
                if (await _userManager.IsInRoleAsync(user, SD.Role_Supervisor))
                {
                            return LocalRedirect(Url.Content("~/Supervisor"));
                }
                else
                {
