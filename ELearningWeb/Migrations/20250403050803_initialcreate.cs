        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Syllabus = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCourseProgress", x => new { x.StudentId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Courses",
                columns: new[] { "Id", "Name", "Overview", "Prerequisites", "ReviewRating", "Subject", "Syllabus" },
                values: new object[,]
                {
                    { 1, "Introduction to C#", "Learn C# basics", "None", 4.5, "Programming", "Variables, Loops, OOP" },
                    { 2, "Web Development with ASP.NET", "Build web apps", "C# basics", 4.7999999999999998, "Web Development", "MVC, Razor, EF Core" },
                    { 3, "Data Structures", "Core CS concepts", "Programming basics", 4.2000000000000002, "Computer Science", "Arrays, Linked Lists, Trees" },
                    { 4, "SQL Fundamentals", "Database basics", "None", 4.0, "Database", "Queries, Joins, Indexes" }
                });
